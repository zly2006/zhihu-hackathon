...
import {updateLockedState,acquireStoryLock,type StateStore} from './state-lock';
export {acquireStoryLock};
...
const store:StateStore<State>={read:readState,save:saveState,isValidId:validId};
