...
function playtestSession():Session{return {id:PLAYTEST_SESSION_ID,expiresAt:Number.MAX_SAFE_INTEGER,oauthState:null,accessToken:'playtest-local',tokenExpiresAt:null,profile:PLAYTEST_PROFILE,error:null};}
function fallbackSession(){return playtestEnabled()?playtestSession():null;}
