...
const suites = [
  ...
  { file: "test/choice-generator-contract.test.mjs", env: "CHOICE_CONTRACT_TEST_DIR" },
  { file: "test/chapter-submission.test.mjs", env: "CHAPTER_SUBMISSION_TEST_DIR" },
  { file: "test/shell-panel-state.test.mjs", env: "SHELL_PANEL_TEST_DIR" },
  ...
  { file: "test/v4-scene-flow.test.mjs", env: "V4_SCENE_FLOW_TEST_DIR" },
  ...
  { file: "test/zhao-leng-prepare.test.mjs", env: "ZHAO_LENG_PREPARE_TEST_DIR" },
  { file: "test/story-runtime.test.mjs", env: "STORY_RUNTIME_TEST_DIR" },
  { file: "test/story-unification.test.mjs", env: "STORY_UNIFICATION_TEST_DIR" },
  { file: "test/execution-budget.test.mjs", env: "EXECUTION_BUDGET_TEST_DIR" },
  { file: "test/scene-boundary-reveal.test.mjs", env: "SCENE_BOUNDARY_REVEAL_TEST_DIR" },
  { file: "test/simulation-repair.test.mjs", env: "SIMULATION_REPAIR_TEST_DIR" },
  { file: "test/generation-error.test.mjs", env: "GENERATION_ERROR_TEST_DIR" },
  { file: "test/npc-generator.test.mjs", env: "NPC_GENERATOR_TEST_DIR" },
  { file: "test/event-content-contract.test.mjs", env: "EVENT_CONTENT_TEST_DIR" },
  { file: "test/llm-request.test.mjs", env: "LLM_REQUEST_TEST_DIR" },
